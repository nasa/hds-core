...
HDS Core exists because of the work of many people across NASA and the open-source community.
...
HDS Core is built on the [U.S. Web Design System (USWDS)](https://designsystem.digital.gov/), maintained by the General Services Administration (GSA) and released into the public domain.

### Typefaces

- **[Inter](https://rsms.me/inter/)** by Rasmus Andersson — SIL Open Font License 1.1
- **[DM Mono](https://github.com/googlefonts/dm-mono)** by Colophon Foundry — SIL Open Font License 1.1
- **[Public Sans](https://github.com/uswds/public-sans)** by USWDS / GSA — CC0 1.0 (Public Domain)

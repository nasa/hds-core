...
> **Note:** HDS palettes handle accessible pairings automatically. This tool is for verifying custom color combinations outside the palette system. For the complete contrast reference, see the accessibility appendix in `508.md`.

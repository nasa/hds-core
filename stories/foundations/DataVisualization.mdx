...
<figure style={{ margin: '1.5rem 0' }}>
  ...
  <figcaption style={{ fontSize: '0.85rem', fontStyle: 'italic', color: '#71767a', marginTop: '0.5rem' }}>Visual reference from HDS Figma — implementation may differ.</figcaption>
</figure>
...
HDS provides categorical colors as CSS custom properties (`--hds-dataviz-cat-1` through `--hds-dataviz-cat-12`) that automatically adapt to light and dark backgrounds. See [Data Visualization Palettes](?path=/docs/foundations-data-visualization-palettes--docs) for the full set of recommended categorical and sequential palettes with usage instructions.
...
- **Categorical color custom properties** — `--hds-dataviz-cat-1` through `--hds-dataviz-cat-12`, palette-aware (automatically switch for dark backgrounds)

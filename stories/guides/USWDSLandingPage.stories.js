// ============================================================
// USWDS Landing Page — Baseline Integration Test
// ============================================================
// Unmodified USWDS Landing Page template markup rendered under
// the HDS Core theme. Tests how stock USWDS components appear
// when an existing USWDS site adopts HDS Core CSS.
//
// Source: https://designsystem.digital.gov/templates/
//
// Components exercised:
//   Banner (gov compliance bar), Header (basic, logo only),
//   Hero (background image + callout), Graphic list (media
//   blocks), Section (default + dark variant), Button (big),
//   Prose content, Footer (slim), Identifier, Skip nav
//
// Header, footer, and banner have no HDS theming yet — they render
// as bare USWDS defaults (real theming is Phase 2). The USWDS
// identifier is pinned to the HDS black palette so its links stay
// legible on the dark identifier surface.
// ============================================================

import { paletteModes } from '../../.storybook/modes';

export default {
  title: 'Guides/Existing USWDS Site/Landing Page',
  parameters: {
    layout: 'fullscreen',
      ...
      <header class="usa-banner__header">
        <div class="usa-banner__inner">
          ...
          <button
            ...
            aria-expanded="false"
            aria-controls="gov-banner-default-landing"
          >
              ...
              <p>
                ...
                <span class="icon-lock"
                  ><svg
                    ...
                    role="img"
                    aria-labelledby="banner-lock-description-landing"
                    focusable="false"
                  >
                    <title id="banner-lock-title-landing">Lock</title>
                    <desc id="banner-lock-description-landing">
                      Locked padlock icon
                    </desc>
                    <path
                      fill="#000000"

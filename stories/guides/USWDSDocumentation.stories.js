// ============================================================
// USWDS Documentation Page — Baseline Integration Test
// ============================================================
// Unmodified USWDS Documentation Page template markup rendered
// under the HDS Core theme. Tests how stock USWDS components
// appear when an existing USWDS site adopts HDS Core CSS.
//
// Source: https://designsystem.digital.gov/templates/
//
// Components exercised:
//   Banner (gov compliance bar), Header (basic + nav),
//   Sidenav (nested), Prose content (h1–h4), Footer (slim),
//   Identifier, Search form, Skip nav
//
// Header, footer, nav, banner, and identifier are not themed by
// HDS yet. They render as stock USWDS, pinned to the palette that
...
export default {
  title: 'Guides/Existing USWDS Site/Documentation',
  parameters: {
    layout: 'fullscreen',
      ...
      <header class="usa-banner__header">
        <div class="usa-banner__inner">
          ...
          <button
            ...
            aria-expanded="false"
            aria-controls="gov-banner-default-doc"
          >
              ...
              <p>
                ...
                <span class="icon-lock"
                  ><svg
                    ...
                    role="img"
                    aria-labelledby="banner-lock-description-doc"
                    focusable="false"
                  >
                    <title id="banner-lock-title-doc">Lock</title>
                    <desc id="banner-lock-description-doc">
                      Locked padlock icon
                    </desc>
                    <path
                      fill="#000000"
      ...
      <nav aria-label="Primary navigation," class="usa-nav">
        ...
        <ul class="usa-nav__primary usa-accordion">
          <li class="usa-nav__primary-item">
            <button
              ...
              aria-expanded="false"
              aria-controls="basic-nav-section-one-doc"
            >
              <span>&lt;Current section&gt;</span>
            </button>
            <ul id="basic-nav-section-one-doc" class="usa-nav__submenu">
        ...
        <section aria-label="Search component">
          <form class="usa-search usa-search--small" role="search">
            <label class="usa-sr-only" for="search-field-doc">Search</label>
            <input
              class="usa-input"
              id="search-field-doc"
              type="search"

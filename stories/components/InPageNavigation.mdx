...
<Note type="code">
  USWDS JavaScript is required for scroll spy and nav link generation. If you render this component dynamically (e.g., in a React or Vue app without <a href="https://github.com/trussworks/react-uswds">react-uswds</a>), reinitialize after mount — see the <a href="?path=/docs/react-setup--docs">React Setup</a> guide.
</Note>

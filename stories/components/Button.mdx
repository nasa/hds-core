...
Text + arrow circle for editorial CTA links in hero sections and content cards. The circle darkens on hover, and the arrow direction auto-swaps for external links. No SVG markup needed — the arrow is rendered via CSS.

...
<Meta of={ProseStories} title="Components/Prose/Guidance" />

# Prose

<Note type="code">
  **Known limitation:** Prose is a work in progress. Some bare-element styles (links, tables, blockquotes, code, horizontal rules, and ordered list typography) do not yet receive full HDS styling inside `.usa-prose`. Lists display correct marker colors and text sizing. A build pipeline update planned before v1.0 will resolve these gaps — see [GitHub Discussion #XX](link) for details.
</Note>
